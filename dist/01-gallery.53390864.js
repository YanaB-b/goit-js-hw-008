...
const galleryBoxMarkup = createBoxItem((0, _galleryItems.galleryItems));
galleryBoxRef.insertAdjacentHTML("afterbegin", galleryBoxMarkup);
function createBoxItem(galleryItems) {
    return galleryItems.map(({ preview , original , description  })=>`<a class="gallery__link" href="${original}">
    <img
...
const galleryBoxModal = new (0, _simplelightboxDefault.default)(".gallery a", {
    captionsData: "alt",
    captionsDelay: 250
});
